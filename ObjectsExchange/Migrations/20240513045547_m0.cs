        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    ClientId = table.Column<Guid>(type: "uuid", nullable: false),
                    CounterReseted = table.Column<DateTime>(type: "timestamp with time zone", nullable: false),
                    ...
                    MaxOperationPerMounth = table.Column<long>(type: "bigint", nullable: false)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    MessageHeader = table.Column<string>(type: "character varying(150)", maxLength: 150, nullable: false),
                    DateStamp = table.Column<DateTime>(type: "timestamp with time zone", nullable: false),
                    SenderDateStamp = table.Column<DateTime>(type: "timestamp with time zone", nullable: true),
                    Message = table.Column<string>(type: "text", nullable: true),
                    ClientNodeId = table.Column<Guid>(type: "uuid", nullable: true)
                },
                constraints: table =>
                {
