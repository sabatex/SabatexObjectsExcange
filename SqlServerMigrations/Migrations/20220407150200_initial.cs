        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Object1CJSON = table.Column<string>(type: "nvarchar(max)", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_UnresolvedObjects", x => x.Id);
                    table.ForeignKey(
                        name: "FK_UnresolvedObjects_Nodes1C_NodeId",
                        column: x => x.NodeId,
                        principalTable: "Nodes1C",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateIndex(
                name: "IX_UnresolvedObjects_NodeId",
                table: "UnresolvedObjects",
                column: "NodeId");
        }
